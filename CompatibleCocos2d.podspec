...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.subspec 'kazmath' do |ss|
    ...
    ss.public_header_files = 'Pod/Classes/kazmath/include/**/*.h'
  end

  s.subspec 'cocos2d' do |ss|
    ss.source_files = 'Pod/Classes/cocos2d/**/*'
    ss.header_mappings_dir = 'Pod/Classes/cocos2d'
  ...
  s.subspec 'CocosDenshion' do |ss|
    ...
    ss.header_mappings_dir = 'Pod/Classes/CocosDenshion'
    ss.public_header_files = 'Pod/Classes/CocosDenshion/*.h'
